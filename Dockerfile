...
RUN apt-get install -y git curl git-core wget build-essential gcc \
	...
	make install && \
	ldconfig && \
	git clone git://git.lttng.org/lttng-ust.git /home/lttng-ust && \
	cd /home/lttng-ust && \
	...
	make install && \
	ldconfig && \
	git clone git://git.lttng.org/lttng-tools.git /home/lttng-tools && \
	cd /home/lttng-tools && \
	git checkout stable-2.6 && \
	./bootstrap && \
	./configure && \
	...
	make install && \
	ldconfig && \
	git clone https://github.com/iojs/io.js.git /home/io.js && \
	cd /home/io.js && \
	git checkout v1.x && \
	./configure --with-lttng && \
	make && \
	make install && \
	usermod -aG tracing vagrant; lttng-sessiond -b